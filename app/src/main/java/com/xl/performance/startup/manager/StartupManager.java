package com.xl.performance.startup.manager;
...
import com.xl.performance.startup.run.StartupRunnable;
import com.xl.performance.startup.store.TaskSort;
...
public class StartupManager {
    ...
    public StartupManager start() {
        ...
        startupSortStore = TaskSort.sort(startupList);
